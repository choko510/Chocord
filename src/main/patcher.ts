...
console.log("[Chocord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Chocord");
    ...
    console.log("[Chocord] Running in vanilla mode. Not loading Chocord");
}

console.log("[Chocord] Loading original Discord app.asar");
