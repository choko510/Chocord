        ...
        <SettingsTab>
            {(isEquicordDonor(user?.id) || isVencordDonor(user?.id)) ? (
                <SpecialCard
                    ...
                    description={
                        isEquicordDonor(user?.id) && isVencordDonor(user?.id)
                            ? "All Vencord users can see your Vencord donor badge, and Chocord users can see your Chocord donor badge. To change your Vencord donor badge, contact @vending.machine. For your Chocord donor badge, make a ticket in Chocord's server."
                            : isVencordDonor(user?.id)
                                ? "All Vencord users can see your badge! You can manage your perks by messaging @vending.machine."
                                : "All Chocord users can see your badge! You can manage your perks by making a ticket in Chocord's server."
                    }
                ...
                <SpecialCard
                    ...
                    description="Please consider supporting the development of Chocord by donating!"
            ...
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Chocord you now have a cool new badge!"
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Chocord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Chocord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
            </Paragraph>
...
export default wrapTab(EquicordSettings, "Chocord Settings");
