...
export const settingVariables = [
    ...
    "",
    "Chocord Variables:",
    "{equicordIcon} - Chocord icon",
    "{equicordVersion} - Version of Chocord (e.g. 1.0.0)",
    "{equicordHash} - Chocord build hash (e.g. 123456789)",
    "{equicordPlatform} - Platform Chocord is running on (e.g. Dev Build)",
    "",
