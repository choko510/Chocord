...
const settings = definePluginSettings({
    showEquicordDonor: {
        ...
        description: "Enable to show Chocord Donor badges in chat.",
        hidden: true,
        default: true
    },
    EquicordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Chocord Donor badges.",
        hidden: true,
        default: 0
    },
    showEquicordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Chocord Contributor badges in chat.",
        hidden: true,
        default: true
    },
    EquicordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Chocord Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://badge.equicord.org/donor.webp", shown: settings.store.showEquicordDonor, title: "Chocord donor badges", key: "EquicordDonor", position: settings.store.EquicordDonorPosition },
        { src: "https://equicord.org/assets/favicon.png", shown: settings.store.showEquicordContributor, title: "Chocord contributor badge", key: "EquicordContributer", position: settings.store.EquicordContributorPosition },
